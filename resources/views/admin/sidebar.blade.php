        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                <a href="#dashboard" data-toggle="collapse"
                   aria-expanded="{{ (request()->is('video','gallery','slider')) ? 'true' : '' }}"
                ...
                <ul class="collapse submenu list-unstyled {{ (request()->is('video','gallery','slider')) ? 'collapse show' : '' }}"
            ...
            <li class="menu">
                <a href="#components" data-toggle="collapse"
                   aria-expanded="{{ (request()->is('reg', 'obzorshop','createshop','redshop')) ? 'true' : '' }}"
                   class="dropdown-toggle">
                    <div class="3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <ul class="collapse submenu list-unstyled {{ (request()->is('reg','obzorshop','createshop','redshop')) ? 'collapse show' : '' }}"
